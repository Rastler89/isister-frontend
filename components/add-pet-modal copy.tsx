...
const AddPetModal = ({onAdd,species,breeds}: AddPetModalProps) => {
                ...
                <form onSubmit={handleSubmit} className='space-y-6 pt-4'>
                    ...
                    <div className='grid gap-4'>
                                ...
                                <PopoverContent className='w-[200px] p-0 z-50'>
                                    <Command className='z-100'>
                                        ...
                                        <CommandList>
                                            ...
                                            <CommandGroup>
                                                {species.map((species) => (
                                                <CommandItem key={species.value} className='z-200' value={species.label} onSelect={handleSpeciesSelect}>
                                                    <Check
                                                    className={cn(
                                                        'mr-2 h-4 w-4',
                        ...
                        <div className='flex justify-end gap-4'>
                            ...
                            >
                                {isLoadingSpecies ? 'Añadiendo...' : 'Añadir mascota'}
                            </Button>
                        </div>
                    </div>
                </form>
